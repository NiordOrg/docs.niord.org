...
The _Sort Area_ action allows the user to sort perform fine-grained persistent sorting
...
This default sorting of messages by area can then be overridden by using the _Sort Area_ action.
...
Notices to Mariners publications should not be modified once the the digest has been published.
