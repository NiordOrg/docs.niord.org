...
The _Action_ menu of the _Editor_ page contain the following actions:
...
Please refer to the <<Add Selection to Tag Action>> action for message lists.
...
that will remove the message from the tag.
