...
The user can click "Add source..." to insert one of the sources created and managed by administrators
in Niord - please refer to the
http://docs.niord.org/admin-manual/manual.html#sources[Sources] admin chapter.

Upon clicking the "Add source" button, a dialog pops up that allows the user to select and add one
